...
import {InputGroup, MenuItem, DropdownButton, Col, Row, Image, Well, Panel, FormControl, FormGroup, ControlLabel, Button} from 'react-bootstrap';
                ...
                <Row>
                    <Col xs={12} sm={6}>
                        <Panel>
                            ...
                            <Image src={this.state.img} responsive style={{marginTop: '10px'}}/>
                        </Panel>
                    </Col>
                    <Col  xs={12} sm={6}>
                        <Panel>
